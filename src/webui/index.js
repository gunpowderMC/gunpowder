...
db.getSecret(s => {
    ...
    app.get('/', ifAuth, function (req, res) {
        renderIndex(req, res, {
            title: 'Home',
            user: req.user
        })
    ...
    app.get('/console', ifAuth, function (req, res, next) {
    ...
    app.get(/^\/users/, ifAuth, function (req, res, next) {
    ...
    app.post('/settings', ifAuth, function (req, res) {
    ...
    app.get(/^\/cron/, ifAuth, function (req, res) {
    ...
    app.post(/^\/cron\/edit\/\w+/, ifAuth, function (req, res) {
        if (hasPerm(req.user, 'cron')) {
